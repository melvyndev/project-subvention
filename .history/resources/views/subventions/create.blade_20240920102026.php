...
<script>
    document.getElementById('type_agriculture').addEventListener('change', function () {
        var type = this.value;
        document.getElementById('cereal_section').classList.toggle('hidden', type !== 'céréalière');
        document.getElementById('horticulture_section').classList.toggle('hidden', type !== 'horticulture');
        document.getElementById('elevage_section').classList.toggle('hidden', type !== 'élevage');
    });
</script>
@endsection
