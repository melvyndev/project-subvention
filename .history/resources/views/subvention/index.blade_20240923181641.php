                                                ...
                                                @foreach ($subventions as $index => $subvention)
                                                    <tr class="{{ $index % 2 === 0 ? 'bg-gray-50' : '' }}">
                                                        ...
                                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium">
                                                            <a href="{{ route('subventions.show', $subvention->id) }}" class="text-gray-600 font-bold hover:text-gray-900 mr-2">{{ __('Voir') }}</a>
                                                            <a href="{{ route('subventions.edit', $subvention->id) }}" class="text-indigo-600 font-bold hover:text-indigo-900 mr-2">{{ __('Modifier') }}</a>
