<div class="space-y-6">
    ...
    <div>
        ...
        <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" :value="old('email', $subvention?->email)" autocomplete="email" placeholder="Email" />
    ...
    <div>
        ...
        <x-text-input id="montant_demande" name="montant_demande" type="number" class="mt-1 block w-full" :value="old('montant_demande', $subvention?->montant_demande)" autocomplete="montant_demande" placeholder="Montant Demande" />
        <x-input-error class="mt-2" :messages="$errors->get('montant_demande')" />
    </div>

    <div>
        <x-input-label for="telephone" :value="__('Téléphone')" />
        <x-text-input id="telephone" name="telephone" type="tel" class="mt-1 block w-full" :value="old('telephone', $subvention?->telephone)" autocomplete="telephone" placeholder="Téléphone" />
    ...
    <div>
        ...
        <x-text-input id="nombre_animaux" name="nombre_animaux" type="number" class="mt-1 block w-full" :value="old('nombre_animaux', $subvention?->nombre_animaux)" autocomplete="nombre_animaux" placeholder="Nombre Animaux" />
        <x-input-error class="mt-2" :messages="$errors->get('nombre_animaux')" />
    </div>

    <div>
        <x-input-label for="piece_identite" :value="__('Pièce d\'Identité')" />
        <x-text-input id="piece_identite" name="piece_identite" type="text" class="mt-1 block w-full" :value="old('piece_identite', $subvention?->piece_identite)" autocomplete="piece_identite" placeholder="Pièce d'Identité" />
    ...
    <div>
        ...
        <x-text-input id="description_beneficiaire" name="description_beneficiaire" type="text" class="mt-1 block w-full" :value="old('description_beneficiaire', $subvention?->description_beneficiaire)" autocomplete="description_beneficiaire" placeholder="Description Bénéficiaire" />
